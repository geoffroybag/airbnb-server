...
const houseSchema = new Schema({
  ...
  recordid: {type : String, algoliaIndex: true},
    review_scores_accuracy:{type : Number, algoliaIndex: true},
      ...
      beds:{type : Number, algoliaIndex: true, required: true},
      bathrooms:{type : Number, algoliaIndex: true, required: true},
      ...
      property_type:{type : String, algoliaIndex: true, required: true},
      ...
      city:{type : String, algoliaIndex: true, required: true},
      ...
      amenities:{type : String, algoliaIndex: true, required: true},
      ...
      description:{type : String, algoliaIndex: true, required: true},
      review_scores_communication:{type : Number, algoliaIndex: true},
      experiences_offered:{type : String, algoliaIndex: true},
      price:{type : Number, algoliaIndex: true, required: true},
      bedrooms:{type : Number, algoliaIndex: true, required: true},
      extra_people:{type : Number, algoliaIndex: true},
      smart_location:{type : String, algoliaIndex: true},
      xl_picture_url:{type : String, algoliaIndex: true, required: true},
      xl_picture_url_2:{type : String, algoliaIndex: true, required: true},
      xl_picture_url_3:{type : String, algoliaIndex: true, required: true},
      ...
      name:{type : String, algoliaIndex: true, required: true},
      medium_url:{type : String, algoliaIndex: true},
      bed_type:{type : String, algoliaIndex: true},
      country:{type : String, algoliaIndex: true, required: true},
      ...
      accommodates: {type : Number, algoliaIndex: true, required: true},
      ...
      room_type: {type : String, algoliaIndex: true, required: true},
